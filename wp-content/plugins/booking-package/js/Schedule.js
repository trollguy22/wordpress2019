    ...
    this.settingPanel = function(accountList, month, day, year, account, callback){
    	...
    	for(var key in inputTypeList){
            ...
            **/
            ...
            if(account.type == 'hotel' && (key == 'courseBool' || key == 'courseTitle' || key == 'displayRemainingCapacity' || key == 'subscriptionIdForStripe' || key == 'termsOfServiceForSubscription')){
                ...
                **/
                ...
                mail_message_save_button.onclick = function(){
                    ...
                    **/
                    ...
                    object.loadingPanel.setAttribute("class", "loading_modal_backdrop");
                    var post = {mode: "updataEmailMessageForCalendarAccount", nonce: object.nonce, action: object.action, mail_id: mailMessageData.key, subject: subject_filed.value, content: value, enable: enable, format: format, accountKey: account.key};
                    console.log(post);
