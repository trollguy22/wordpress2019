    ...
    class setting {
        ...
        **/
        ...
        public function getList(){
            ...
            $list =  array(   
                "General" => array(
                    ...
                    **/
                    ...
                    'currency' => array('name' => __('Currency', $this->pluginName), 'value' => 'usd', 'isExtensionsValid' => 0, 'inputLimit' => 2, 'inputType' => 'RADIO', 'valueList' => array('usd' => 'USD', 'eur' => 'EUR', 'jpy' => 'JPY - 日本円', 'dkk' => 'Dansk krone', 'cny' => 'CNY - 人民币', 'twd' => 'TWD - 台湾元', 'thb' => 'THB - Thai Baht', 'cop' => 'COP - Colombian Peso')),
            ...
            $dateFormatList = array("m/d/Y", "m-d-Y", "F d, Y", "d/m/Y", "d-m-Y", "d F, Y", "Y/m/d", "Y-m-d");
        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                'timezone' => array('key' => 'timezone', 'name' => 'Timezone', 'value' => 'open', 'inputLimit' => 1, 'inputType' => 'SELECT_TIMEZONE', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array()),
                ...
                'courseBool' => array('key' => 'courseBool', 'name' => 'Enable the service function', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array(1 => 'Enable', 0 => 'Disable')),
        ...
        **/
        ...
        public function updataEmailMessageForCalendarAccount(){
            ...
            $wpdb->update(
                $table_name,
                array('subject' => $subject, 'content' => $content, 'enable' => $enable, 'format' => $format),
